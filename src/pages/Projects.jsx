  ...
  return (
    <section className='max-container'>
      <h1 className='head-text'>
        ...
        drop-shadow'>Contents</span>
      </h1>

      <div className='mt-5 flex flex-col gap-3 text-2xl font-semibold text-slate-500'>
        <p>
          Gamer & student at the same time. I love to play games and learn new things.
          I am a great fan of <span className='font-semibold'>RPG</span> games.
        </p>
      </div>
